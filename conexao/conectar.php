...
//Conecta com o banco de dados de Aluno
include_once('../aluno/Aluno.php');
//Conecta com o banco de dados de Contrato
include_once ('../contrato/Contrato.php');
//Conecta com o banco de dados de Escola
include_once ('../escola/Escola.php');
//Conecta com o banco de dados de Pagamento
