...
CREATE TABLE `aluno` (
  ...
  KEY `fk_aluno_cidade1_idx` (`id_cidade`),
  CONSTRAINT `fk_aluno_cidade1` FOREIGN KEY (`id_cidade`) REFERENCES `cidade` (`id_cidade`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `aluno` VALUES (1,'Mateus Lorençone Moreira','1995-01-16','M','(61) 9857-89297','Quadra 06 conjunto D 01 Veredas',49809,'N',1,1,4),(2,'Diego Carlos Armanio','1990-01-16','M','(61) 9876-32547','Quadra 3 conjunto G 55 Veredas',785,'M',1,2,4);
