...
<div class="container" style="margin-top: 60px;">
    ...
    <form method="post" action="processamento.php?acao=salvar" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <label class="radio-inline"><input required type="radio" name="tipo_pagamento" id="tipo_pagamento"
                                                   value="A" <?= $pagamento->getTipoPagamento() == "A" ? "checked" : ''; ?>>À
                    vista</label>
                <label class="radio-inline"><input required type="radio" name="tipo_pagamento" id="tipo_pagamento"
                                                   value="B" <?= $pagamento->getTipoPagamento() == "B" ? "checked" : ''; ?>>Boleto</label>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="number" class="form-control" id="parcelas" name="parcelas"
                       value="<?= $pagamento->getParcelas(); ?>">
            </div>
        </div>
        <div class="form-group">
            <label for="valor_parcelado" class="col-sm-2 control-label">Valor Parcelado</label>
            <div class="col-sm-10">
                <input type="number" class="form-control" id="valor_parcelado" name="valor_parcelado"
                       value="<?= $pagamento->getValorParcelado(); ?>">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="date" class="form-control" id="data_desconto" name="data_desconto"
                       value="<?= $pagamento->getDataDesconto(); ?>">
            </div>
        </div>
        <div class="form-group">
...
<script>
    ...
    $('#id_contrato').change(function () {
        ...
        $.ajax({
            url: 'processamento.php?acao=buscarvalor&' + $('#id_contrato').serialize(),
